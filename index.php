...
<body>
    ...
    <p>
        <a href="backend/authentication/reset-password.php" class="btn btn-warning">Reset Your Password</a>
        <a href="backend/authentication/logout.php" class="btn btn-danger ml-3">Sign Out of Your Account</a>
    </p>
	<p id="success"></p>
				...
				<td>
					...
					<td>
						<a href="#editEmployeeModal" class="edit" data-toggle="modal">
							...
							data-id="<?php echo $row["id_service"]; ?>"
							data-name="<?php echo $row["customer_name"]; ?>"
							data-email="<?php echo $row["customer_email"]; ?>"
							data-service-name="<?php echo $row["service_name"]; ?>"
							data-expiration="<?php echo $row["service_expiration"]; ?>"
							title="Edit"></i>
						</a>
						<a href="#deleteEmployeeModal" class="delete" data-id="<?php echo $row["id_service"]; ?>" data-toggle="modal"><i class="material-icons" data-toggle="tooltip"
						 title="Delete"></i></a>
                    </td>
				</tr>
				<?php
